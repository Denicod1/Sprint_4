...
public class OrderBigTest {
    ...
    public OrderBigTest(String name, String surname,String adress,String station,String phone,String comment, String date, WebDriver driver)
    {
        Name=name;
        Surname=surname;
        Adress=adress;
    ...
    public void TestStart() {
        ...
        firstPageObject.clickBigOrderButton();
